/*
 * Notes on outside help:
 * Please edit this block before submission so it matches what actually happened.
 *
 * AI usage:
 *   I used AI as a learning/debugging tool to understand D3 v5 brushing,
 *   linked views, and animated transitions. I reviewed the code and changed
 *   it to fit my Pokemon dashboard design and dataset.
 */

// Store the Pokemon type selected from the overview bar chart.
let selectedType = null;

// Store the active rectangular brush selection from the scatter plot.
let brushSelection = null;

// Give the dashboard a minimum size so the three views do not overlap on small windows.
