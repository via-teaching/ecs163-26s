# Homework 3: Visualization Dashboard Part 2 (Interactivity)

For Homework 3, you will extend your Homework 2 dashboard to include interactions and animated transitions. **You may start fresh, i.e., select different datasets from HW2 or design different visualizations.**
...
To submit for this assignment, you need to first [fork](https://docs.github.com/en/free-pro-team@latest/github/getting-started-with-github/fork-a-repo) this [repository](https://github.com/via-teaching/ecs163-26s). After the fork, clone the forked repository using the following commands:
...
Create a new folder inside the Homework 3 directory in the forked repository. The name of the folder should be the same as your UC Davis email account name (without ' @ucdavis.edu'). Put all your code inside this folder, and use "git add" to add your code, and then commit.
