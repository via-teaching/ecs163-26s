...
const topH  = Math.floor(svgH * 0.42);
const botH  = svgH - topH;
const halfW = Math.floor(svgW / 2);
...
d3.csv("cosmetics.csv").then(function(data) {
    ...
    var pcW = svgW - pcM.left - pcM.right;
    var pcH = topH - pcM.top - pcM.bottom;
    ...
    var scW = halfW - scM.left - scM.right;
    var scH = botH - scM.top - scM.bottom;

    var scG = svg.append("g")
        .attr("transform", "translate(" + scM.left + "," + (topH + scM.top) + ")");
    ...
    var barW = halfW - barM.left - barM.right;
    var barH = botH - barM.top - barM.bottom;

    var barG = svg.append("g")
        .attr("transform", "translate(" + (halfW + barM.left) + "," + (topH + barM.top) + ")");
