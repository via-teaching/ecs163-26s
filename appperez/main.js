...
let sankeyMargin = {top: 10, right: 30, bottom: 30, left: 60},
    scatterWidth = 400 - sankeyMargin.left - sankeyMargin.right,
    scatterHeight = 350 - sankeyMargin.top - sankeyMargin.bottom;
...
d3.csv("players.csv").then(rawData =>{
    ...
    const g1 = svg.append("g")
                .attr("width", scatterWidth + sankeyMargin.left + sankeyMargin.right)
                .attr("height", scatterHeight + sankeyMargin.top + sankeyMargin.bottom)
